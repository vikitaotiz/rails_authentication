...
[Live Demo Link](https://vikita-authentication.herokuapp.com/)
...
- Clone the repository with the command: `git clone (copied link)`; like so: `git clone https://github.com/vikitaotiz/rails_authentication.git`
- After the clone, type in the command `cd rails_authentication` to access the app directory on the terminal
